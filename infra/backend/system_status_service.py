...
BACKUP_RESTORE_DEEP_DIVE = [
    ...
    },
    {
        ...
        "body": "A Gitea nem teljes backup, hanem verziókövetés. Arra való, hogy lásd, mikor változott konfiguráció, script vagy compose fájl, és vissza tudj nézni korábbi állapotokra. Titkokat és runtime adatokat szándékosan nem visz fel.",
        "items": [
            "Remote repository: ssh://git@192.168.1.2:2222/homecontrol/config.git.",
            "Webes repo: http://192.168.1.2:3002/homecontrol/config.",
            "Mentett területek: homeassistant/config, homeassistant/docker-compose.yml, infra/docker-compose.yml, scripts, apps, backup dokumentáció.",
            "Kizártak: .env, secrets.yaml, infra/ssh, adatbázisok, logok, cache, Home Assistant .storage, deps, tts, runtime capture adatok.",
